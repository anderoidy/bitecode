(function () {
  ...
  (self["webpackChunkbitecode"] = self["webpackChunkbitecode"] || []).push([["polyfills-es5"], {
    /***/
    99:
    /*!*********************************************************************************!*\
    ...
    function _(module) {
      ...
      var _mergeSort = function mergeSort(array, comparefn) {
        var length = array.length;
        var middle = floor(length / 2);
        return length < 8 ? insertionSort(array, comparefn) : merge(_mergeSort(array.slice(0, middle), comparefn), _mergeSort(array.slice(middle), comparefn), comparefn);
      };
    ...
    function _(__unused_webpack_module, __unused_webpack_exports, __webpack_require__) {
      ...
      7597); // `Date.prototype.toISOString` method
      // https://tc39.es/ecma262/#sec-date.prototype.toisostring
